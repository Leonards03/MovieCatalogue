...
public class TvShow {
    ...
    public TvShow(int id, String backdrop, String poster, String title, ArrayList<Genre> dummyGenres, String overview, String rating, String releaseDate) {
        this.id = id;
        ...
        for (int i = 0; i < dummyGenres.size(); i++) {
            if (i == dummyGenres.size() - 1)
                text.append(dummyGenres.get(i).getName());
            else
                text.append(dummyGenres.get(i).getName()).append(", ");
        }
        this.genre = text.toString();
    }
